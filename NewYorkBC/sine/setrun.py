...
#------------------------------
    ...
    clawdata.lower[0] = -74.4
    clawdata.upper[0] = -71.1
    clawdata.lower[1] = 40.1
    clawdata.upper[1] = 41.3
    ...
    gauges.append([0,-71.1,40.6,0,1e9])  
    gauges.append([1,-72.5,40.4,0,1e9])  

    gauges.append([560,-71.96,41.04,0,1e9])
    gauges.append([9050,-74.06,40.61,0,1e9])
    gauges.append([5186,-73.26,40.62,0,1e9])
...
#-------------------
    ...
    topodir = '../topography/'
    topofiles.append([3, topodir + 'etopo1_-74.5_-71_40_41.4_1min.asc'])
