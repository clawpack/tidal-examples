...
subroutine bc2amr(val,aux,nrow,ncol,meqn,naux, hx, hy, level, time,   &
    ...
    INTEGER :: col,max_cols
    delt = possk(level)
    jump_h = sin(2*pi*(time+delt)/(12*3600))- sin(2*pi*(time)/(12*3600))
    hxmarg = hx * .01d0
    hymarg = hy * .01d0
        ...
        select case(mthbc(1))
            case(0) ! User defined boundary condition
              do j = 1, ncol
                  do i=1, nxl
                      aux(:, i, j) = aux(:, nxl + 1, j)
                      val(3, i, j) = val(3, nxl + 1, j)
                      val(1, i, j) = val(1, nxl + 1, j) + jump_h
                      val(2, i, j) = val(2, nxl + 1, j)
            ...
            case(0) ! User defined boundary condition
                ...
                do i = ibeg, nrow
                    do j = 1, ncol
                        ...
                        val(1, i, j) = val(1, ibeg - 1, j) + jump_h
            ...
            case(0) ! User defined boundary condition
                ...
                do j = 1, nyb
                    do i = 1, nrow
                      ...
                      val(1, i, j) = val(1, i, nyb + 1) + jump_h
            ...
            case(0) ! User defined boundary condition
                ...
                do j = jbeg, ncol
                    do i = 1, nrow
                        ...
                        val(1, i, j) = val(1, i, jbeg - 1) + jump_h
